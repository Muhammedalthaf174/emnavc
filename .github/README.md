...
[Yukki Music Bot](https://github.com/muhammedalthaf174/emnavc) is a Powerful Telegram Music+Video Bot written in Python using Pyrogram and Py-Tgcalls by which you can stream songs, video and even live streams in your group calls via various sources.
...
> Want detailed explanation of Heroku Deployment? [Click Here](https://muhammedalthaf174.gitbook.io/emnavc/deployment/heroku)

## 🚀 Okteto Deployment

<h4>Click the button below to deploy Yukki on Okteto!</h4>
<a href="https://cloud.okteto.com/deploy?repository=https://github.com/Muhammedalthaf174/emnavc"><img src="https://img.shields.io/badge/Deploy%20To%20Okteto-informational?style=for-the-badge&logo=Okteto" width="200""/></a>



## 🖇 VPS Deployment

> Checkout [Docs](https://notreallyshikhar.gitbook.io/emnavc/deployment/local-hosting-or-vps) for Detailed Explanation on VPS Deploy


```console
shikhar@MacBook~ $ git clone https://github.com/Muhammedalthaf174/emnavc
...
- [GitHub Issues](https://github.com/TeamYu/yukkimusicbot/issues/new?assignees=&labels=question&template=SUPPORT_QUESTION.md&title=support%3A+)
- Contact options listed on [this GitHub profile](https://github.com/Muhammedalthaf174)
...
- Add a [GitHub Star](https://github.com/Muhammedalthaf174/emnavc) to the project.
- Fork the Repo :)
